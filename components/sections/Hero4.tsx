                            ...
                            <div className="col-lg-11">
                                ...
                                <div className="hero-flex-wrap">
                                    <div className="hero-flex-content">
                                        <p className="hero-text wow img-custom-anim-left text-white" data-wow-duration="1.5s" data-wow-delay="0.1s">Beautiful design has the power to captivate audiences. Multixion specializes in creating stunning designs.</p>
